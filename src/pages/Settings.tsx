...
import { useRemainingBudget} from "@/contexts/RemainBudget";

const Settings: React.FC = () => {
  const { transactions, addTransaction } = useTransactions();
  const { theme, toggleTheme } = useTheme();
  const [importError, setImportError] = useState<string | null>(null);
  const { financialSummary  } = useRemainingBudget();
    ...
    reader.onload = (e) => {
      try {
        ...
        for (let i = 1; i < lines.length; i++) {
          ...
          const dateStr = `${dateParts[2]}-${dateParts[0].padStart(
            2,
            "0"
          ...
          const transaction = {
            ...
            date: dateStr,
            isRecurring:
              recurringIndex !== -1 ? values[recurringIndex] === "Yes" : false,
          };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-lg text-gray-500 dark:text-gray-400">
                Total Remaining budget amount ₹ {financialSummary.balance}      
              </h1>
            </div>
          </div>
        </CardContent>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                A simple, privacy-focused finance tracker that helps you manage
                your income, expenses, and budget. All your data is stored
